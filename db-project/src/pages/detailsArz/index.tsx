...
import { isInCart } from '../../shared/cartHelper'
...
const DetailsArz: FC = () => {
  ...
  const [listCartArz, setListCartArz] = useState<any>([])
  const [listComments, setListComments] = useState<any>([])
  const navigate = useNavigate()
  const cartContextArz = useContext(CartContext)
  console.log(cartContextArz)
  ...
  const sendComments = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    fetch(`http://127.0.0.1:8000/digital/currencies/${id}/comments/`, {
      method: 'POST',
    ...
    <div className="container mt-12">
      <div className="relative">
        ...
        <div className="shadow-sm bg-white h-auto rounded-xl p-9 flex gap-x-9">
          <div>
            <img
              src={randomImages(listArzs[0]?.title)}
              alt="image"
          ...
          <div>
            ...
            <div className="mt-4 flex items-center justify-between">
              <div>
                <button
                  className="flex items-center gap-x-3 bg-primary-300 p-3 text-white font-Yek-ExtraBold rounded-xl text-lg hover:ring-[7px] transition-all duration-300"
                  onClick={() => navigate(-1)}
                >
